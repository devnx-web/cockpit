...
// venv default — pode ser sobrescrito pela env var COCKPIT_VOICE_PYTHON.
// Em produção, o ideal é o cliente apontar pra um Python com omnivoice instalado.
const VENV_PYTHON = process.env.COCKPIT_VOICE_PYTHON || "/home/ftgk/Documents/omnivoice-test/.venv/bin/python";
...
export function init({ configPath: cp } = {}) {
  if (cp) configPath = cp;
}
