...
Versão atual: **0.6.4** ([changelog](https://arquivos.devnx.com.br/cockpit/v0.6.4/CHANGELOG.md))
...
```bash
curl -L https://arquivos.devnx.com.br/cockpit/v0.6.4/cockpit-devnx_0.6.4_amd64.deb -o /tmp/cockpit.deb
...
```bash
curl -L https://arquivos.devnx.com.br/cockpit/v0.6.4/Cockpit-0.6.4.AppImage -o ~/Cockpit.AppImage
...
# .deb
dpkg -l cockpit
# espera: ii  cockpit-devnx  0.6.4  amd64
...
Disponíveis no mesmo bucket — basta trocar `v0.6.4` no path:
