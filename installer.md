...
```bash
curl -L https://arquivos.devnx.com.br/cockpit/v0.6.5/cockpit-devnx_0.6.5_amd64.deb -o /tmp/cockpit.deb
...
```bash
curl -L https://arquivos.devnx.com.br/cockpit/v0.6.5/Cockpit-0.6.5.AppImage -o ~/Cockpit.AppImage
...
# .deb
dpkg -l cockpit
# espera: ii  cockpit-devnx  0.6.5  amd64
...
Disponíveis no mesmo bucket — basta trocar `v0.6.5` no path:
