...
Versão atual: **0.6.8** ([changelog](https://arquivos.devnx.com.br/cockpit/v0.6.8/CHANGELOG.md))

> Instalador one-liner: `curl -fsSL https://arquivos.devnx.com.br/cockpit/v0.6.8/install.sh | sudo bash`
...
```bash
curl -L https://arquivos.devnx.com.br/cockpit/v0.6.8/cockpit-devnx_0.6.8_amd64.deb -o /tmp/cockpit.deb
...
```bash
curl -L https://arquivos.devnx.com.br/cockpit/v0.6.8/Cockpit-0.6.8.AppImage -o ~/Cockpit.AppImage
...
# .deb
dpkg -l cockpit
# espera: ii  cockpit-devnx  0.6.8  amd64
...
Disponíveis no mesmo bucket — basta trocar `v0.6.8` no path:
